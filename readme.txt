...
Drag-and-drop reordering of WooCommerce product categories with hierarchy management.
...
Yes, this plugin is specifically designed for WooCommerce product categories.

= Will reordering affect my existing categories? =

No, this plugin only changes the display order of categories. It does not modify category names, descriptions, or product assignments.

= Can I change the category hierarchy? =

Yes, you can use the ◀▶ arrow buttons to promote or demote categories within the hierarchy.

== Screenshots ==

1. Category Order page with drag & drop interface
2. Parent categories filter active
3. Highlighted root categories without subcategories
